...
public final class PlayerStoryData {
    ...
    /**
     * NeoForge/Forge does not copy {@link net.minecraft.world.entity.Entity#getPersistentData()} on respawn.
     * Call from {@link net.neoforged.neoforge.event.entity.player.PlayerEvent.Clone}.
     */
