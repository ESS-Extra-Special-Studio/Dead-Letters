 ...
 */
@EventBusSubscriber(modid = Dead_letters.MODID, bus = EventBusSubscriber.Bus.MOD)
public class Config {
    private static final ModConfigSpec.Builder BUILDER = new ModConfigSpec.Builder();

    // --- Loot / chests ---
    private static final ModConfigSpec.DoubleValue SPAWN_CHANCE;
    private static final ModConfigSpec.IntValue MAX_NOTES_PER_CHEST;
    private static final ModConfigSpec.BooleanValue GUARANTEE_STARTER_SCRAPBOOK_FIRST_CHEST;
    private static final ModConfigSpec.BooleanValue GUARANTEE_FIRST_LOOTR_CHEST;

    // --- Progression / stories ---
    private static final ModConfigSpec.BooleanValue USE_PROGRESSION;
    private static final ModConfigSpec.BooleanValue ALLOW_DUPLICATES;
    private static final ModConfigSpec.DoubleValue PART_ONE_DROP_WEIGHT;
    private static final ModConfigSpec.DoubleValue FINAL_PART_DROP_WEIGHT;
    private static final ModConfigSpec.BooleanValue ENABLE_MULTIPLE_STORIES;

    // --- Placement ---
    private static final ModConfigSpec.BooleanValue PLACE_NOTES_REQUIRE_SNEAK;
    private static final ModConfigSpec.BooleanValue PLACE_SCRAPBOOK_REQUIRE_SNEAK;

    // --- Custom stories ---
    private static final ModConfigSpec.BooleanValue CUSTOM_STORIES_ENABLE;
    private static final ModConfigSpec.ConfigValue<String> CUSTOM_STORIES_PATH;
    private static final ModConfigSpec.BooleanValue CUSTOM_STORIES_ALLOW_OVERRIDES;
    private static final ModConfigSpec.BooleanValue CUSTOM_STORIES_LOG_LOADING;

    // --- Debug ---
    private static final ModConfigSpec.BooleanValue DEBUG_TESTING_MODE;
    private static final ModConfigSpec.BooleanValue DEBUG_LOG_LOOT_DECISIONS;
