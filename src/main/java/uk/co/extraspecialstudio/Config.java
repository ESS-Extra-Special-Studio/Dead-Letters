...
public class Config {
    ...
    private static final ModConfigSpec.DoubleValue PART_ONE_DROP_WEIGHT = BUILDER
    ...
    private static final ModConfigSpec.DoubleValue FINAL_PART_DROP_WEIGHT = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue GUARANTEE_FIRST_LOOTR_CHEST = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue GUARANTEE_STARTER_SCRAPBOOK_FIRST_CHEST = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue ENABLE_MULTIPLE_STORIES = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue CUSTOM_STORIES_ENABLE = BUILDER
            .comment("Loads stories from config/deadletters/stories.")
            .define("customStories.enable", true);

    private static final ModConfigSpec.ConfigValue<String> CUSTOM_STORIES_PATH = BUILDER
            .comment("Relative to the Minecraft config directory.")
            .define("customStories.path", "deadletters/stories");

    private static final ModConfigSpec.BooleanValue CUSTOM_STORIES_ALLOW_OVERRIDES = BUILDER
            .comment("If true, config stories can override datapack stories by ID.")
            .define("customStories.allowOverrides", true);

    private static final ModConfigSpec.BooleanValue CUSTOM_STORIES_LOG_LOADING = BUILDER
            .comment("Logs custom story loading details.")
            .define("customStories.logLoading", true);

    private static final ModConfigSpec.BooleanValue DEBUG_TESTING_MODE = BUILDER
            .comment("Enables aggressive testing defaults for faster validation.")
            .define("debug.testingMode", false);

    private static final ModConfigSpec.BooleanValue DEBUG_LOG_LOOT_DECISIONS = BUILDER
